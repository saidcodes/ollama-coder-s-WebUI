...
/*  "https://c4c662b54698.ngrok-free.app" */
...
export const Cog8ToothIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  props
) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const CogIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m16.5 0H21m-1.5 0H12m-8.457 3.077l1.41-.513m14.095-5.13l-1.41-.513M3 10.5h18M4.757 14.923l1.41.513M17.833 7.577l-1.41.513M9.043 18.923l-1.41-.513M13.5 3.077v1.41M10.5 20.923v-1.41M16.957 18.923l1.41-.513M6.257 5.077L4.847 5.59"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const TrashIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12.56 0c1.153 0 2.24.032 3.22.096M15 3.75V2.25A2.25 2.25 0 0012.75 0h-1.5A2.25 2.25 0 009 2.25v1.5"
    />
  </svg>
);
...
> = (props) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3.543-3.543A9.753 9.753 0 0112 15.75c-1.036 0-2.022.186-2.917.533l-4.285 4.285A9.753 9.753 0 015.25 19.5c-4.61 0-8.477-3.526-8.477-7.889 0-1.218.342-2.734 1.023-4.016C1.06 5.995 2.667 3.75 5.25 3.75c1.743 0 3.304.836 4.316 2.206C10.608 7.46 11.25 8.774 11.25 10.125c0 .283-.015.563-.044.838M21.75 12.188c0 .593-.042 1.177-.122 1.754M12 10.125c0 1.612.409 3.293 1.182 4.75M8.665 13.94a4.5 4.5 0 016.67-.342"
    />
  </svg>
);
...
export const SparklesIcon0000: React.FC<React.SVGProps<SVGSVGElement>> = (
  props
) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
